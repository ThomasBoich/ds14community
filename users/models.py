...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    TYPE_ROLE = [
        ...
        (MANAGER, 'Manager'),
        (CURATOR, 'Curator'),
        (JUNIOR_CURATOR, 'Junior Curator'),
        (SENIOR_EVENT_MASTER, 'Senior Event Master'),
        (GAME_MASTER, 'Game Master'),
        (EVENT_WARDEN, 'Event Warden'),
        (EVENT_MASTER, 'Event Master'),
        (JUNIOR_EVENT_MASTER, 'Junior Event Master'),
        (SENIOR_MODERATOR, 'Senior Moderator'),
        (MODERATOR, 'Moderator'),
        (JUNIOR_MODERATOR, 'Junior Moderator'),
        (JUDE, 'Jude'),
        (SOUL_EATER_KNIGHT, 'Soul Eater Knight'),
        (SOUL_EATER, 'Soul Eater'),
        (COMMUNITY_MANAGER, 'Community Manager'),
        (SENIOR_SPRITER, 'Senior Spriter'),
        (SENIOR_MAPPER, 'Senior Mapper'),
        (WIKI_EDITOR, 'Wiki Editor'),
        (LOR_CURATOR, 'Lor Kurator'),
        (SENIOR_ARTIST, 'Senior Artist'),
        (SMM_MANAGER, 'SMM Manager'),
        (WIKI_CURATOR, 'Wiki Kurator'),
        (LOR_EDITOR, 'Lor Editor'),
        (MAPPER, 'Mapper'),
        (SPRITER, 'Spriter'),
        (YOUTUBER, 'Youtuber'),
        (ARTIST, 'Artist'),
        ...
        (SMOOKER_KNIGHT, 'Smooker Knight'),
    ]

    type = models.CharField(max_length=6, choices=TYPE_ROLE, default=MANAGER, verbose_name='Type User')
